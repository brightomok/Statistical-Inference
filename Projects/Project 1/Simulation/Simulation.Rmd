...
The raw data as a scatter plot comes out of the simulation looking like figure 1. We can see that the data becomes more and more concentrated around 0 which indicates an exponential distribution.

```{r hist, fig.height = 5, echo=FALSE}
...
```{r hist2,echo = FALSE}
par(mfrow=c(1,2))
hist(dat, breaks = 33, prob = TRUE, xlab = "Variable", main = "Sample")
curve(exp(-lambda*x), from = 0, to = 100, n = 100, main = "Theoretical")
```
